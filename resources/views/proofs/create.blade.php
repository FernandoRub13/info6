...
<div class="container mx-auto py-8">
    <div class="grid lg:grid-cols-3">
        ...
        <div class="col-span-2 bg-white shadow rounded-lg overflow-hidden">
            <form action="{{route('proofs.store')}}" method="POST" novalidate>
                <div class="space-y-3 p-4">
                    ...
                    @csrf
                        ...
                        @endif
                                                                                ...
                                                                                <div class="">
                        <label class="block text-sm font-semibold text-gray-700" for="url_clean">Url Clean</label>
                                                <input name="url_clean"                         type="text"
                        maxlength="255"
                                                class="mt-1 focus:ring-blue-500 focus:border-blue-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded String"
                                                required="required"
                                                >
                ...
                <div class="bg-gray-100 flex items-center justify-between px-4 py-5 space-x-3">
                    ...
                    <button class="px-6 py-1.5 border-lg bg-blue-500 text-blue-50 font-semibold rounded hover:bg-blue-700">Create Proof </button>
                </div>
            </form>
        </div>
    </div>
